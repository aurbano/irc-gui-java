...
public class AcercaDe extends JDialog {
	 ...
	 */
	public AcercaDe() {
		final JDialog ventana = new JDialog(ClienteChat.frame, "Acerca De - ClienteChat v3", Dialog.ModalityType.APPLICATION_MODAL);
		...
		JLabel lblClientechatV = new JLabel("ClienteChat v3");
		...
		JLabel lblEpiGijn = new JLabel("EPI Gij\u00F3n - Computadores - 2013");
